...
import { createMockAuthContext, mockProfile, mockHospital } from '../../src/test/mocks/auth';
...
describe('useCreateConsultation', () => {
  ...
  it('inserts consultation with hospital_id scoping', async () => {
    ...
    const singleMock = vi.fn().mockResolvedValue({ data: mockConsultation, error: null });
