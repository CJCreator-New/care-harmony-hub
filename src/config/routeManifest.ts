...
export const routeManifest: AppRouteManifestGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/nurse/protocols',
        icon: ClipboardList,
        allowedRoles: ['admin', 'nurse'],
        requiredPermission: 'vitals:write',
        releaseTier: 'tier2',
        testOwner: 'integration',
      },
    ],
    ...
    items: [
      {
        ...
        icon: Stethoscope,
        allowedRoles: ['admin', 'doctor', 'nurse'],
        requiredPermission: 'consultations:read',
        releaseTier: 'tier1',
        testOwner: 'integration',
      },
      {
        ...
        icon: Video,
        allowedRoles: ['admin', 'doctor', 'nurse'],
        requiredPermission: 'telemedicine:read',
        releaseTier: 'tier2',
        testOwner: 'e2e',
      },
      {
        label: 'Voice Clinical Notes',
        href: '/voice-clinical-notes',
        icon: Mic,
        allowedRoles: ['admin', 'doctor', 'nurse'],
        requiredPermission: 'voice-clinical-notes',
        releaseTier: 'tier2',
        testOwner: 'integration',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Stethoscope,
        allowedRoles: ['admin', 'pharmacist'],
        requiredPermission: 'clinical-pharmacy',
        releaseTier: 'tier2',
        testOwner: 'integration',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/laboratory/automation',
        icon: Activity,
        allowedRoles: ['admin', 'lab_technician'],
        requiredPermission: 'laboratory',
        releaseTier: 'tier2',
        testOwner: 'api-security',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Stethoscope,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'differential-diagnosis',
        releaseTier: 'tier3',
        featureFlag: 'ai_clinical_tools',
        testOwner: 'integration',
      },
      {
        ...
        icon: Pill,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'treatment-recommendations',
        releaseTier: 'tier3',
        featureFlag: 'ai_clinical_tools',
        testOwner: 'integration',
      },
      {
        label: 'Treatment Plan Optimization',
        href: '/treatment-plan-optimization',
        icon: Target,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'treatment-plan-optimization',
        releaseTier: 'tier3',
        featureFlag: 'ai_clinical_tools',
        testOwner: 'integration',
      },
      {
        ...
        icon: BarChart3,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'predictive-analytics',
        releaseTier: 'tier3',
        featureFlag: 'ai_analytics',
        testOwner: 'integration',
      },
      {
        label: 'Length of Stay Forecasting',
        href: '/length-of-stay-forecasting',
        icon: Clock,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'length-of-stay-forecasting',
        releaseTier: 'tier3',
        featureFlag: 'ai_analytics',
        testOwner: 'integration',
      },
      {
        ...
        href: '/resource-utilization-optimization',
        icon: Target,
        allowedRoles: ['admin', 'doctor'],
        requiredPermission: 'resource-utilization-optimization',
        releaseTier: 'tier3',
        featureFlag: 'ai_analytics',
        testOwner: 'integration',
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Activity,
        allowedRoles: ['admin'],
        requiredPermission: 'staff-performance',
        releaseTier: 'tier1',
        testOwner: 'integration',
      },
      {
      ...
      },
      {
        ...
        icon: Activity,
        allowedRoles: ['admin'],
        requiredPermission: 'system-monitoring',
        releaseTier: 'tier1',
        testOwner: 'api-security',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        requiredPermission: 'workflow-dashboard',
        releaseTier: 'tier1',
        testOwner: 'api-security',
      },
    ],
