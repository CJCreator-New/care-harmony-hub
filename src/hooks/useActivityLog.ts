...
export type ActionType = 
  ...
  | 'staff_deactivate'
  | 'settings_update'
  | 'prescription_approval_review'
  | 'prescription_approval_approve'
  | 'prescription_approval_reject'
  | 'prescription_approval_clarify'
  | 'prescription_approval_dispense'
  | 'prescription_approval_complete'
