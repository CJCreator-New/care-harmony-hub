    ...
    try {
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert clinical diagnostician. Provide differential diagnoses based on the patient's symptoms, history, and vital signs. Always include:
...
Format your response as structured clinical notes.`
      ...
      throw new Error(`OpenAI diagnosis failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
    ...
    try {
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert clinical pharmacologist and treatment specialist. Create evidence-based treatment plans that include:
...
Consider drug interactions, contraindications, and patient-specific factors.`
      ...
      throw new Error(`OpenAI treatment planning failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
    ...
    try {
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert clinical decision support system. Generate evidence-based treatment recommendations for the given diagnoses.
...
Consider patient allergies, current medications, comorbidities, and evidence-based guidelines.`
      ...
      throw new Error(`OpenAI treatment recommendations failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
- Provide realistic, evidence-based predictions`;
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a clinical decision support AI specializing in treatment plan optimization. Always respond with valid JSON containing treatment plan optimizations.'
          },
          {
            role: 'user',
            content: prompt
      ...
      throw new Error(`OpenAI treatment plan optimization failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
- Model metrics should reflect real ML performance`;
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a healthcare predictive analytics AI specializing in readmission risk assessment. Always respond with valid JSON containing risk analysis.'
          },
          {
            role: 'user',
            content: prompt
      ...
      throw new Error(`OpenAI readmission risk prediction failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
- Impact values show days added/subtracted from baseline`;
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a healthcare predictive analytics AI specializing in length of stay forecasting. Always respond with valid JSON containing stay duration analysis.'
          },
          {
            role: 'user',
            content: prompt
      ...
      throw new Error(`OpenAI length of stay forecasting failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
- Consider patient safety and care quality in all optimization suggestions`;
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a healthcare operations optimization AI specializing in hospital resource management. Always respond with valid JSON containing comprehensive optimization analysis.'
          },
          {
            role: 'user',
            content: prompt
      ...
      throw new Error(`OpenAI resource utilization optimization failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
    ...
    try {
      ...
      const completion = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert clinical pharmacologist. Review medication regimens for:
...
Provide specific recommendations with clinical reasoning.`
        ...
        max_tokens: 2000,
        temperature: 0.1, // Very low for medication safety
      });
      ...
      throw new Error(`OpenAI medication review failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
Please review this medication regimen for safety and appropriateness.`;
  ...
  private calculateConfidence(response: string): number {
    ...
    // In production, use more sophisticated confidence scoring
