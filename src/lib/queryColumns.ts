...
export const PATIENT_COLUMNS = {
  ...
  detail:
    'id, mrn, first_name, last_name, date_of_birth, gender, phone, email, address, city, state, zip, blood_type, allergies, chronic_conditions, emergency_contact_name, emergency_contact_phone, insurance_provider, insurance_policy_number, is_active, created_at',
...
export const APPOINTMENT_COLUMNS = {
  ...
  detail:
    'id, scheduled_date, scheduled_time, status, appointment_type, priority, patient_id, doctor_id, duration_minutes, reason_for_visit, notes, check_in_time, start_time, end_time, queue_number, created_at, updated_at',
  calendar:
    'id, scheduled_date, scheduled_time, status, appointment_type, patient_id, doctor_id, duration_minutes',
  queue:
    'id, scheduled_date, scheduled_time, status, priority, patient_id, queue_number, check_in_time',
};
...
export const LAB_ORDER_COLUMNS = {
  list: 'id, test_name, status, priority, ordered_at, patient_id, ordered_by, is_critical, critical_notified_at, completed_at, test_category, specimen_type, results, result_notes, hospital_id',
  detail:
    'id, test_name, status, priority, ordered_at, completed_at, results, patient_id, ordered_by, processed_by, is_critical, critical_notified_at, result_notes, test_category, specimen_type, hospital_id',
...
export const MEDICATION_COLUMNS = {
  ...
  detail:
    'id, hospital_id, name, generic_name, category, form, strength, unit, manufacturer, current_stock, minimum_stock, unit_price, expiry_date, batch_number, is_active, created_at, updated_at',
...
export const PRESCRIPTION_COLUMNS = {
  ...
  detail:
    'id, medication_name, dosage, frequency, duration, instructions, status, patient_id, prescribed_by, created_at, dispensed_at, pharmacy_notes',
...
export const ACTIVITY_LOG_COLUMNS = {
  ...
  detail:
    'id, action_type, entity_type, entity_id, details, ip_address, user_agent, created_at, user_id',
...
export const WORKFLOW_TASK_COLUMNS = {
  ...
  detail:
    'id, title, description, status, priority, assigned_to, created_by, due_date, completed_at, created_at, updated_at',
...
export const BILLING_COLUMNS = {
  ...
  detail:
    'id, invoice_number, total_amount, status, items, patient_id, insurance_coverage, payment_method, created_at, paid_at',
...
export const INVENTORY_COLUMNS = {
  ...
  detail:
    'id, name, category, description, current_stock, minimum_stock, maximum_stock, unit, unit_cost, supplier_id, expiry_date, status, created_at',
...
export const STAFF_COLUMNS = {
  ...
  detail:
    'id, first_name, last_name, email, phone, role, department, license_number, specializations, hire_date, is_active, created_at',
...
export function buildHospitalScopedSelect(
  table: string,
  columns: string,
  hospitalId: string
): string {
...
export function getColumnsForView(
  table: string,
  view: 'list' | 'detail' | 'search' | 'minimal' = 'list'
): string {
  const columnSets = {
